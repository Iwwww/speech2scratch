 ...
 *   startRecognitionBlock: string,
 *   getSpeechBlock: string,
 * }} I18nData
 */

/**
 * @type{{ en: I18nData, ru: I18nData, ja: I18nData }}
 */
const I18n = {
  en: {
    extensionName: "Speech Recognition",
    startRecognitionBlock: "start speech recognition",
    getSpeechBlock: "speech",
  },
  ru: {
    extensionName: "Распознавание речи",
    startRecognitionBlock: "начать распознавание речи",
    getSpeechBlock: "распознанная речь",
  },
  ja: {
    extensionName: "音声認識",
    startRecognitionBlock: "音声認識開始",
    getSpeechBlock: "音声",
  },
};
...
class Scratch3Speech2Scratch {
  ...
  constructor(runtime) {
    ...
    const availableLocales = ["en", "ru", "ja"];
    /**
     * @type {I18nData}
     */
    this.i18n =
      I18n[availableLocales.includes(currentLocale) ? currentLocale : "en"];
  }

  getInfo() {
    return {
      id: Scratch3Speech2Scratch.EXTENSION_ID,
      name: this.i18n.extensionName,
      ...
      blocks: [
        {
          ...
          text: this.i18n.startRecognitionBlock,
        },
        {
          opcode: "getSpeech",
          blockType: BlockType.REPORTER,
          text: this.i18n.getSpeechBlock,
        },
      ],
      menus: {},
    };
